...
import { FoodItemI, UserPreferencesI } from '../../models/interfaces.model';

@Injectable({
  providedIn: 'root'
})
export class userpreferenceApiService {

  url: String = 'http://localhost:8080';

  constructor(private http: HttpClient) { }

  userpreferenceApiService(): Observable<UserPreferencesI> {
