    ...
    public static TransactionCallback<SettingsModel> getSettingsTransaction(String email) {
        ...
        return transaction -> {
            ...
            if (result.hasNext()) {
                ...
                String shoppingInterval = record.get("shoppingInterval").isNull() ? null
                ...
                String cookingTime = record.get("cookingTime").isNull() ? "normal"
                        : record.get("cookingTime").asString();
                ...
                Boolean cookingTimeSet = record.get("cookingTimeSet").isNull() ? false
                        : record.get("cookingTimeSet").asBoolean();
                Boolean allergiesSet = record.get("allergiesSet").isNull() ? false
                ...
                Boolean foodPreferenceSet = record.get("foodPreferenceSet").isNull() ? false
                        : record.get("foodPreferenceSet").asBoolean();
                Boolean shoppingIntervalSet = record.get("shoppingIntervalSet").isNull() ? false
